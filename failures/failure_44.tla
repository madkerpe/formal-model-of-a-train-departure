...
(*
	CHANGE
	system.spoor = "vrij" -> system.spoor = "n_vrij"
*)
Init == /\ TypeInvariant
        /\ system.trein = "perron"
...
(*
	CHANGE
	system.spoor = "vrij" verwijderd
*)
best_wil_vertrekken == /\ system.licht = "wit"
                       /\ system.bestuurder = "wacht"
                       /\ system.BAB = "aan"
...
veiligheidseis3 == system.trein = "vertrokken" => system.spoor = "vrij"
