---- MODULE AC_failure_geen_rood_probleem ----
EXTENDS Naturals
VARIABLES system
...
AC_waarden == {"aan", "uit"}
licht_waarden == {"uit", "rood", "wit", "stroom_rood"}(* Aangepast om fout te simuleren *)
bestuurder_waarden == {"wacht", "wil_vertrekken", "rood_gezien"}(* Aangepast om fout te simuleren *)
...
activeren_AC == /\ system.startuur = "aangebroken"
                ...
                /\ system.begeleider = "perron"
                /\ system.AC = "uit"
                /\ system' = [system EXCEPT !.AC = "aan", !.licht = "stroom_rood"](* Aangepast om fout te simuleren *)

licht_op_wit == /\ \/ system.licht = "rood"
				   \/ system.licht = "stroom_rood" (* Aangepast om fout te simuleren *)
                /\ system' = [system EXCEPT !.licht = "wit"]

best_wil_vertrekken == /\ system.spoor = "vrij"
                       /\ system.licht = "wit"
                       /\ system.bestuurder = "rood_gezien"(* Aangepast om fout te simuleren *)
                       /\ system.BAB = "aan"
